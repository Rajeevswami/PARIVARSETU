...
export const navigation: NavigationItem[] = [
  ...
  { label: "Audit logs", to: "/audit", icon: FileText, roles: ["family_admin"] },
  { label: "Billing", to: "/billing", icon: CreditCard, roles: ["family_admin"] },
  { label: "Settings", to: "/settings", icon: Settings },
  { label: "Family", to: "/family", icon: Settings, roles: ["family_admin"] },
];
