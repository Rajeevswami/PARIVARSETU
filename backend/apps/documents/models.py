...
class DocumentAccessLog(models.Model):
    id=models.UUIDField(primary_key=True,default=uuid.uuid4,editable=False); family=models.ForeignKey("families.Family",on_delete=models.CASCADE,related_name="document_access_logs"); document=models.ForeignKey(Document,on_delete=models.CASCADE,related_name="access_logs"); member=models.ForeignKey("members.Member",null=True,blank=True,on_delete=models.SET_NULL,related_name="document_access_logs"); action=models.CharField(max_length=20); ip_address=models.GenericIPAddressField(null=True,blank=True); device=models.CharField(max_length=255,blank=True); browser=models.CharField(max_length=255,blank=True); created_at=models.DateTimeField(auto_now_add=True)
