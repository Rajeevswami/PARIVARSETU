    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("notification_number", models.CharField(max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            options={"db_table": "notifications_announcement"},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "notifications_activity_timeline", "ordering": ["-created_at"]},
        ),
        migrations.CreateModel(
            name="LoginHistory",
            fields=[
            ...
            options={"db_table": "notifications_login_history", "ordering": ["-login_time"]},
        ),
        migrations.CreateModel(
            name="SecurityEvent",
            fields=[
            ...
            options={"db_table": "notifications_security_event", "ordering": ["-created_at"]},
        ),
        migrations.AddIndex(
            model_name="notification",
            index=models.Index(
                fields=["recipient", "is_read", "-created_at"],
                name="notificatio_recipie_6850ba_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="activitytimeline",
            index=models.Index(
                fields=["family", "module", "-created_at"], name="notificatio_family__0df3ee_idx"
            ),
        ),
    ]
